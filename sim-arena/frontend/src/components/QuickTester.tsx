  ...
  const handleQuickStart = () => {
    ...
    useMainStore.setState({
      ...
      Master_Timeline: [
        ...
        // SỬA CHỖ NÀY ĐỂ ELARA CHẾT HẲN: -230 HP (Máu cũ đang là 230)
        { "time_offset_ms": 20400, "type": "ATTACK", "actor_id": "char-assassin-004", "target_id": "char-mage-002", "hp_change": -230, "is_critical": true },
        ...
        { "time_offset_ms": 20800, "type": "VFX", "target_id": "char-mage-002", "duration_ms": 2000, "css_override": { "filter": "grayscale(100%) blur(4px)" }, "web_animation": { "keyframes": [ { "transform": "translateY(0) scale(1)", "opacity": 1 }, { "transform": "translateY(-10px) scale(0.5)", "opacity": 0 } ], "options": { "duration": 2000, "fill": "forwards" } }, "canvas_commands": [ { "action": "DRAW_CIRCLE", "centerX": 7, "centerY": 9, "radius": 2, "color": "rgba(138, 43, 226, 0.3)", "fill": true } ] },
        ...
        // SỬA CHỖ NÀY ĐỂ NYX CHẾT HẲN: -255 HP (Máu cũ đang là 255)
        ...
        { "time_offset_ms": 30800, "type": "ATTACK", "actor_id": "char-hero-001", "target_id": "char-assassin-004", "hp_change": -255, "is_critical": true },
        ...
        { "time_offset_ms": 31500, "type": "VFX", "target_id": "char-assassin-004", "duration_ms": 3000, "css_override": { "filter": "grayscale(100%) blur(5px)" }, "web_animation": { "keyframes": [ { "transform": "scale(0.8) translateY(0)", "opacity": 1 }, { "transform": "scale(0) translateY(20px)", "opacity": 0 } ], "options": { "duration": 2000, "iterations": 1, "fill": "forwards" } }, "canvas_commands": [ { "action": "DRAW_CIRCLE", "centerX": 6, "centerY": 9, "radius": 1.5, "color": "rgba(0, 0, 0, 0.8)", "fill": true, "glow": true, "shadowBlur": 20, "shadowColor": "black" } ] },
        ...
        // SỬA CHỖ NÀY ĐỂ MARCUS CHẾT HẲN: -300 HP (Máu cũ đang là khoảng 75)
        { "time_offset_ms": 46200, "type": "ATTACK", "actor_id": "char-boss-003", "target_id": "char-hero-001", "hp_change": -300, "is_critical": true },
        ...
        { "time_offset_ms": 47200, "type": "VFX", "target_id": "char-hero-001", "duration_ms": 2800, "css_override": { "filter": "grayscale(100%) blur(10px)" }, "web_animation": { "keyframes": [ { "transform": "translate(-15px, 15px) scale(0.5) rotate(-30deg)", "opacity": 1 }, { "transform": "translate(-15px, 30px) scale(0) rotate(-60deg)", "opacity": 0 } ], "options": { "duration": 2000, "fill": "forwards", "easing": "ease-in" } }, "canvas_commands": [ { "action": "DRAW_CIRCLE", "centerX": 7, "centerY": 9, "radius": 1, "color": "rgba(255, 215, 0, 0.8)", "fill": true, "glow": true, "shadowBlur": 20, "shadowColor": "gold" }, { "action": "DRAW_CIRCLE", "centerX": 7, "centerY": 8.5, "radius": 0.5, "color": "rgba(255, 255, 255, 0.8)", "fill": true } ] },
